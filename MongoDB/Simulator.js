...
class Simulator{
    ...
    createEvent(){
        ...
        event.setEventKind(enums.typesOfEvent.EntSection);
    ...
    nextSection(event){
        ...
        event.setEventKind(enums.typesOfEvent.ExSection);
        let today = new Date();
    ...
    exitFromRoad(event){
        ...
        event.setTime(today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds());
        this.sendEvent(event.toString());
        event.setEventKind(enums.typesOfEvent.ExRoad);
        setTimeout(() => {this.sendEvent(event.toString());}, 100);
    }
    ...
    run(){
        ...
        setInterval(() => {
            ...
            if(this.day === 0)
                this.day = enums.dayInWeek.Saturday; 
